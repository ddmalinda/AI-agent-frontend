...
import LogoutButton from "../componets/buttons/LogoutButton"
        ...
        <div className="bg-bgcolor px-5">
            <div className="container mx-auto justify-between flex shadow z-100 bg-white   h-[80px] items-center max-md:hidden rounded-b-2xl">
                ...
                <Link to={pagesLinkpath.homePage}>
                    <div className="font-audiowide uppercase text-xl font-bold hover:text-blue-600 cursor-pointer">
                        home 
                    </div>
                </Link>
                <Link to={pagesLinkpath.testpage}>
                    <div className="font-audiowide uppercase text-xl font-bold hover:text-blue-600 cursor-pointer">
                        test 
                    </div>
                </Link>
